...
<html>
	...
	<body>
						...
						<div class="def-bk" id="bk-exam-control">
							...
							<div class="def-bk-content" id="exam-control">
								...
								<div id="question-submit">
									<button class="btn-success btn" style="width:100%;" onclick="examing.finishExam()">
										我要交卷
									</button>
								</div>
							...
							<div class="expand-bk-content" id="bk-conent-exampaper">
								<div id="exampaper-header">
									...
									<div id="exampaper-desc-container">
										...
										<!--  选择题   -->
										<c:forEach  items="${paper.questions}"  var="question"  varStatus="st"
					>
											<c:if test="${question.question_type_id==1}">
												<li class="${question.question_type_id }">
												     <div> ${st.count}.${question.description }</div>
										    ...
										    <c:if test="${question.question_type_id==4}">
												<li class="${question.question_type_id }"  >
												     <div  >${st.count}.${question.description }</div>
												     <textarea id="${question.id}" rows="5" cols="80" ></textarea>
												</li>
										    </c:if>
										</c:forEach>
									</ul>
		...
		<script type="text/javascript" src="resources/js/examing.js"></script>
